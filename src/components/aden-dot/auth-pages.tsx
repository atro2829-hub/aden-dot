        ...
        <motion.div className="mt-6" variants={fadeIn} initial="initial" animate="animate" transition={{ delay: 0.3 }}>
          ...
          <div className="flex gap-3">
            <motion.button
              ...
              disabled={isLoading}
              className="flex-1 h-11 rounded-xl bg-card border border-border text-foreground text-sm flex items-center justify-center gap-2 hover:bg-muted transition-colors disabled:opacity-50"
              whileTap={{ scale: 0.97 }}
            >
