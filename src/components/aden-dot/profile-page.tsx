  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        <div className="h-36 rounded-2xl overflow-hidden bg-gradient-to-b from-primary/10 to-background">
          {/* Decorative pattern */}
        ...
        <div className="absolute -bottom-14 left-4">
          <div className="relative">
            <div className="w-[88px] h-[88px] rounded-full p-[3px] bg-primary">
          ...
          <div className="py-4">
            ...
            {activeTab === 'liked' && (
              <motion.div
                ...
                className="text-center py-10"
              >
                <svg width={28} height={28} viewBox="0 0 24 24" fill="none" stroke="var(--muted-foreground)" strokeWidth="1.5" className="mx-auto mb-3">
